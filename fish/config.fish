...
function theme --description 'смена обоев + темы терминала'
    qs -c noctalia-shell ipc call wallpaper random eDP-1
    sleep 2
    python3 ~/.config/scripts/theme.py
end
...
alias space='df -h'
alias cava='cava -p ~/.config/cava/themes/noctalia'
alias nano='nvim'
